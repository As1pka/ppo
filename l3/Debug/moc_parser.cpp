...
QT_MOC_LITERAL(1, 7, 12), // "routeIsReady"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "Route"
QT_MOC_LITERAL(4, 27, 5), // "route"
QT_MOC_LITERAL(5, 33, 12), // "createNewWay"
QT_MOC_LITERAL(6, 46, 6), // "QFile&"
QT_MOC_LITERAL(7, 53, 7) // "gpxFile"

    },
    "Parser\0routeIsReady\0\0Route\0route\0"
    "createNewWay\0QFile&\0gpxFile"
};
...
void Parser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->routeIsReady((*reinterpret_cast< Route(*)>(_a[1]))); break;
        case 1: _t->createNewWay((*reinterpret_cast< QFile(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Parser::*_t)(Route );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parser::routeIsReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Parser::routeIsReady(Route _t1)
{
