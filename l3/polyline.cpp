...
QString Polyline::encode(const QList<QGeoCoordinate> &route)
{
...
QList<QGeoCoordinate> Polyline::decode(const QString &polyline)
{
    QList<QGeoCoordinate> route;
    QGeoCoordinate currentcoordinate(0, 0, 0);
...
QString Polyline::encodeCoordinate(const QGeoCoordinate &coordinate)
{
    return encodeNumber(coordinate.latitude()) + encodeNumber(coordinate.longitude());
}

QString Polyline::encodeNumber(double number)
{
...
int Polyline::decodeCoordinate(QString &polyline, QGeoCoordinate &coordinate)
{
...
double Polyline::decodeNumber(QString &polyline)
{
    int i = 0;
